...
[1] González-Delgado J, González-Sanz A, Cortés J, Neuvial P: Two-sample goodness-of-fit tests on the flat torus based on Wasserstein distance and their relevance to structural biology. Electron. J. Statist., 17(1): 1547–1586, 2023. [[url]]([https://hal.archives-ouvertes.fr/hal-03369795v2](https://doi.org/10.1214/23-EJS2135)) [[HAL]]([https://hal.archives-ouvertes.fr/hal-03369795v2](https://hal.archives-ouvertes.fr/hal-03369795)).
